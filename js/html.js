...
function add_spec_ext_to_element(element, p_preferredChild)
{
    ...
    element._toggle = function(p_fadeTime)
    {
        this._show(!this.isShown(), p_fadeTime);
        return element;
    }
    ...
    */
    element._show = function(p_isShow, p_fadeTime)
    {
    ...
    element._hide = function(p_fadeTime)
    {
        this._show(false, p_fadeTime);
        return element;
    }
